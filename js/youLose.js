var loseState = {
	...
	create: function() { 
		...
		// Nombre del juego 
		var nameLabel = game.add.text(400, -40, 'Perdiste! D:', { font: '57px Impact', fill: '#D2D2D2' }); 
		...
		var startLabel = game.add.text(400, game.world.height-200, '¡¡Presiona la flecha ABAJO para volver a jugar!!', { font: '25px Impact', fill: '#FFF922' }); 
